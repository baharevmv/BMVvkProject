...
@property (nonatomic, strong) BMVCoreDataDownloadFacade *coreDataDownloadFacade;
...
- (instancetype)init
{
	...
	if (self)
	{
		_coreDataDownloadFacade = [BMVCoreDataDownloadFacade new];
...
{
	[self.coreDataDownloadFacade obtainVKFriendsWithLocalToken:self.tokenForFriendsController
